...
export const getExtension = <T>(obj: ISpecificationExtension<T>, extensionName: string): T | undefined => {
...
export const addExtension = <T>(obj: ISpecificationExtension<T>, extensionName: string, extension: T): void => {
	if (SpecificationExtension.isValidExtension(extensionName)) {
...
export const getPath = (pathsObject: PathsObject, path: string): PathItemObject | undefined => {
...
export type EncodingObject = ISpecificationExtension<EncodingPropertyObject>;
...
export interface ResponsesObject extends ISpecificationExtension<ResponseObject | ReferenceObject> {
...
export type CallbacksObject = ISpecificationExtension<CallbackObject | ReferenceObject>;
export type CallbackObject = ISpecificationExtension<PathItemObject>;
